...
/*ObtenerAvatar sube el avatar al servidor. Resumen se pasa el ID q me vino, lo chequeo, hago una busqueda de perfil por ese ID, lo cargo en un modelo, sino hubo un error sigo, intento abrir el archivo sino hubo un error sigo y hago una copia del arch a mi response writer */
